...
room2.door2.lock()
//배경
room2.bed=new Item(room2, 'bed', '2아기침대-측면.png',100, 800, 450) 
room2.mobile=new Item(room2, 'mobile', '2아기모빌.png',100, 800, 400)

//사용아이템
room2.milk=new Item(room2, 'milk', '2우유.png', 100, 200, 600)
room2.milk.onClick=function()
{
	room2.milk.pick()	
} 
room2.diaper=new Item(room2, 'diaper', 't1.png', 100, 1100, 400) 
room2.diaper.onClick=function()
{
	room2.diaper.pick()	
} 
room2.toy=new Item(room2, 'toy', 't2.png', 100, 700, 550) 
...
function phase(){
				...
				babystate=Math.floor(Math.random()*2)
				//playSound("애기웃는소리.wav")
				game.setTime(tim)
...
{
	room2.baby.close()
	room2.baby.resize(100)
	room2.baby.locate(800, 450)
				
	room2.baby.setSprite("t3.png")
	room2.door2.close()
	game.hideTimer()
}	
}	
...
Game.start(room2, '평화로운 주말….어제 회식 때문에 너무 머리가 아프다… 엇 저기 아침밥상이 있군 아이조아')
